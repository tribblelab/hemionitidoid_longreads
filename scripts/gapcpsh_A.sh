...
# User settings
# ------------------------------------------------------------
BASE_CONFIG="/mmfs1/gscratch/tribblelab/hemionitidoid_longreads/input/namedrefsrun/gapcpsh_A.txt"
...
# CCS input file
# ------------------------------------------------------------
INPUT_FASTQ="${PROJECT_ROOT}/input/poolA.ccs.fastq"
OUT_PREFIX="poolA"
OUT_DIR="${OUTPUT_ROOT}/purc_poolA"
CONFIG_OUT="${PROJECT_ROOT}/input/purc_config_poolA.conf"
